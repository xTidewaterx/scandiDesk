...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#faf8f5] text-[#1a1a1a]">
      ...
      {/* NAVBAR */}
      <nav className="absolute top-0 left-0 w-full z-20 px-10 py-6 flex justify-between items-center">
        <h1 className="text-white text-xl tracking-wide font-light drop-shadow">
          ScandiDesk
        </h1>

        <ul className="flex gap-10 text-white text-sm tracking-wide drop-shadow">
      ...
      {/* HERO */}
      <section className="relative w-full h-[60vh] flex items-end justify-center pb-20 mb-32">
        <Image
      ...
      <footer className="py-24 text-center text-sm text-[#6a6a6a] bg-white mt-24">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-3 opacity-90">
            ...
            />
            <span className="text-base tracking-wide text-[#4a4a4a]">
